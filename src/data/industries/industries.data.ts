export const INDUSTRIES_BANNER_SECTION = {
  heading: "Transforming Industries Through Technology and Innovation",
  description:
...
export const INDUSTRIES_SECTION = {
  ...
  description:
    "At Stratger.ai, we bring digital transformation to life across multiple industries. Our expertise lies in delivering intelligent, scalable, and result-driven solutions that help businesses evolve, perform, and lead in the digital age.",
  industries: [
    {
...
export const INDUSTRY_CTA_SECTION = {
  ctaText:
