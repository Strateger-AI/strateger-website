import { TESTIMONIALS_SECTION_DATA } from "@/data/main.data";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
export function TestimonialSection() {
  return (
    <Container className="space-y-5 ">
      ...
      {/*</h1>*/}
      <GradientTextHeading
        headingParts={TESTIMONIALS_SECTION_DATA.headingParts}
      />

      <div>
        <Carousel className="w-full  ">
          <CarouselContent className={" "}>
            {TESTIMONIALS_SECTION_DATA.testimonials.map(
              (testimonial, index) => (
                <CarouselItem
                  key={index}
                  ...
                  >
                    <CardContent className="relative !rounded-xl   flex h-full flex-col">
                      ...
                      >
                        ...
                        <p className={"text-black text-md md:text-xl"}>
