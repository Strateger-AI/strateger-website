...
// import { REAL_ESTATE_HERO_SECTION } from "@/data/industries/realstate.data";
//
...
//             {REAL_ESTATE_HERO_SECTION.headingParts.map((part, i) => (
...
//             {REAL_ESTATE_HERO_SECTION.content}
//           </p>
//
//           <div className="grid  gap-2 grid-cols-2 lg:grid-cols-3 lg:gap-4 xl:grid-cols-4">
//             {REAL_ESTATE_HERO_SECTION.stats.map((stat, index) => {
//               return (
//                 <div
//                   ref={ref}
//                   key={index}
...
//           </div>
//           <CTAButton2
//             href={REAL_ESTATE_HERO_SECTION.CTABtnLink}
//             className={"self-start"}
//             label={REAL_ESTATE_HERO_SECTION.CTAButton}
//           />
//         </div>
//         <div className="w-full max-w-md lg:w-1/2 lg:max-w-2/5">
//           <Image
//             src={REAL_ESTATE_HERO_SECTION.bannerImg}
//             height={200}
//             width={500}
