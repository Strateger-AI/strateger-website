import { FINTECH_SERVICES_SECTION } from "@/data/industries/fintech.data";
  ...
  return (
    <div className="space-y-5 px-5 py-5 md:space-y-10 md:px-20 md:py-10">
      <h1 className="text-center text-2xl sm:text-3xl leading-snug font-bold whitespace-pre-line md:text-5xl">
        {FINTECH_SERVICES_SECTION.headingParts.map((part, i) => (
      ...
      <p className={"text-center text-lg"}>
        {" "}
        {FINTECH_SERVICES_SECTION.description}
      </p>
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3  xl:px-10">
        {FINTECH_SERVICES_SECTION.services.map((service, index: number) => {
