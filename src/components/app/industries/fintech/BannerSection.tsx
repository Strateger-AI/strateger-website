...
export function BannerSection() {
  ...
  return (
    <div
      className={
        "mt-10 flex min-h-screen flex-col items-center justify-center px-5 py-10 md:mt-2 md:px-20  lg:gap-8"
      }
    >
      <div
        className={
      ...
      >
        ...
        >
          <h1 className="text-center text-3xl  leading-snug md:text-start md:text-5xl">
            {FINTECH_HERO_SECTION.headingParts.map((part, i) => (
          ...
          <p
            className={
              "text-center whitespace-pre-line md:text-start md:text-xm"
            }
          >
            {FINTECH_HERO_SECTION.content}
          </p>

          <div className="grid  gap-2 grid-cols-2 lg:grid-cols-3 lg:gap-4 xl:grid-cols-4">
            {FINTECH_HERO_SECTION.stats.map((stat, index) => {
              return (
                <div
                  ref={ref}
                  key={index}
                ...
                >
                  <div className="bg-primary flex h-full max-w-56 flex-col items-center justify-center rounded-xl px-6 py-4 text-white hover:shadow-xl">
          ...
          <CTAButton2
            href={FINTECH_HERO_SECTION.CTABtnLink}
            className={"self-start"}
            label={FINTECH_HERO_SECTION.CTAButton}
          />
        </div>
        <div className="w-full max-w-md lg:w-1/2 lg:max-w-2/5">
          <Image
            src={FINTECH_HERO_SECTION.bannerImg}
            height={200}
            width={500}
