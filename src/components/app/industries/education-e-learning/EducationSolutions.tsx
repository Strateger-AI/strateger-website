          ...
          >
            ...
            >
              <div className="flex flex-col items-start gap-5 rounded-xl p-6 md:p-10">
                <h2 className="text-center lg:text-start text-3xl leading-normal font-bold lg:text-4xl">
                ...
                <p className="mb-6 text-black lg:text-xl">
                  {solution.description}
                </p>
                <ul className="text-primary grid w-full list-inside list-disc grid-cols-1 gap-3 space-y-2 font-bold md:grid-cols-1">
                  {solution.points.map((point, i) => (
                    <li className={"md:text-sm lg:text-lg"} key={i}>
                      {point}
                    </li>
                  ))}
                </ul>
