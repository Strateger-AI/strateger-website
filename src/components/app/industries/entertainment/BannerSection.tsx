...
import { ENTERTAINMENT_HERO_SECTION } from "@/data/industries/entertainment.data";
      ...
      >
        ...
        >
          <h1 className="text-center text-3xl leading-snug md:text-start md:text-5xl">
            {ENTERTAINMENT_HERO_SECTION.headingParts.map((part, i) => (
          ...
          <p className={"text-center md:text-start md:text-lg"}>
            {ENTERTAINMENT_HERO_SECTION.content}
          </p>
          ...
          <CTAButton2
            href={ENTERTAINMENT_HERO_SECTION.CTABtnLink}
            className={"self-start"}
            label={ENTERTAINMENT_HERO_SECTION.CTAButton}
          />
        </div>
        <div className="w-full max-w-md lg:w-1/2 lg:max-w-2/5">
          <Image
            src={ENTERTAINMENT_HERO_SECTION.bannerImg}
            height={200}
            width={500}
