import { ENTERPRISE_SERVICES_SECTION } from "@/data/industries/enterprise.data";
  ...
  return (
    <div className="space-y-5 px-5 py-5 md:space-y-10 md:px-20 md:py-10">
      <h1 className="text-center text-3xl leading-snug whitespace-pre-line md:text-5xl">
        {ENTERPRISE_SERVICES_SECTION.headingParts.map((part, i) => (
      ...
      <p className={"text-center text-lg"}>
        {" "}
        {ENTERPRISE_SERVICES_SECTION.description}
      </p>
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-20">
        {ENTERPRISE_SERVICES_SECTION.services.map((service, index: number) => {
