...
// import { DEEP_LEARNING_BANNER_SECTION } from "@/data/services/deep-learning.data";
...
//             {DEEP_LEARNING_BANNER_SECTION.headingParts.map((part, i) => (
...
//             }
//           >
//             {DEEP_LEARNING_BANNER_SECTION.content}
//           </p>
//
//           <CTAButton2
//             className={""}
//             href={DEEP_LEARNING_BANNER_SECTION.CTABtnLink}
//             label={DEEP_LEARNING_BANNER_SECTION.CTABtnText}
//           />
//         </div>
//         <div className="w-full max-w-md lg:w-1/2 lg:max-w-2/5">
//           <Image
//             src={DEEP_LEARNING_BANNER_SECTION.img || "/mobile-app-UI.jpg"}
//             height={200}
//             width={500}
