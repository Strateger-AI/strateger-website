...
export function CTABusinessSection({
  ...
  return (
    <div className="relative flex max-w-full flex-col items-center justify-center space-y-5 px-5 py-5 md:space-y-10 md:px-20 md:py-10">
        ...
        {data.stats.map((stat, index) => (
          ...
          >
            <span className="text-4xl font-bold">
              {inView ? <CountUp start={0} end={stat.stat} duration={5} /> : 0}
