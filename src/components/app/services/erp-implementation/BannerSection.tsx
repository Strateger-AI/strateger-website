...
import { BANNER_SECTION } from "@/data/services/erp-implementation.data";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 className="text-center text-3xl leading-snug md:text-start md:text-6xl">
        ...
        <div className="w-full max-w-md lg:w-1/2 lg:max-w-2/5">
          <Image
            src={BANNER_SECTION.img || "/mobile-app-UI.jpg"}
            height={200}
            width={500}
