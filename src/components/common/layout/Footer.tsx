    ...
    <footer className="bg-primary text-background md:px-10 lg:px-4 py-10">
      ...
      <div className="hidden lg:mx-auto space-y-10 lg:max-w-[90rem] px-4 md:flex md:flex-col itemsc">
        ...
        <div className="text-white block lg:hidden  ">
          <h2 className="mb-6 text-2xl text-center font-bold">Our Locations</h2>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <span className="text-lg font-semibold">{loc.title}</span>
        ...
        {/* === BOTTOM SECTION === */}
        <h1 className="text-sm  text-center border-t-[1px] border-secondary py-4 text-gray-400">
